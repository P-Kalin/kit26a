...
public class ExtraFunctions {
	...
	public static String showCommands() {
		...
		return "Выберите команду:\n1. Создание списка из 5 элементов\n"
				+ "2. Создание нового списка на основе предыдущего\n"
				+ "3. Сортировка списка по количеству дней пребывания в отеле\n"
				+ "4. Сортировка списка по фамилии гостя\n" + "5. Сортировка списка по классу номера гостя"
				+ "6. Сортировка списка по причине пребывания гостя в отеле" + "7. Сортировка списка по номеру комнаты"
				+ "8. Сортировка списка по количеству мест в номере" + "9. Очистка списка"
				+ "10. Стандартная сериализация/десериализация списка"
				+ "11. Нестандартная сериализация/десериализация списка" + "12. Выход";
	}
