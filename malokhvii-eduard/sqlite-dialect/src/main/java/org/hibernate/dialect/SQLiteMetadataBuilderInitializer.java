...
public class SQLiteMetadataBuilderInitializer
    ...
    private final static Logger logger = Logger
            .getLogger(SQLiteMetadataBuilderInitializer.class);

    @Override
    public void contribute(MetadataBuilder metadataBuilder,
            StandardServiceRegistry serviceRegistry) {
        final DialectResolver dialectResolver = serviceRegistry
    ...
    static private final DialectResolver resolver = new DialectResolver() {
        ...
        private static final long serialVersionUID = -7884414923924058333L;
