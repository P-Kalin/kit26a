...
public class NumberEqualityContainer implements DataContainer {
    ...
    public final DataCollectionStatus collectData(final PrintStream out,
            final Scanner in) {
        out.printf("[-]: Please, enter your number: ",
                NumberEqualityContainer.MAX_NUMBER);
        ...
        if (this.number <= NumberEqualityContainer.MIN_NUMBER
                && this.number <= NumberEqualityContainer.MAX_NUMBER) {
